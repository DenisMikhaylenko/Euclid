...
function e(e,r,t){return(1-t)*e+t*r}function r(e,r){e=e.replace("#","");var t=parseInt(3==e.length?e.slice(0,1).repeat(2):e.slice(0,2),16),o=parseInt(3==e.length?e.slice(1,2).repeat(2):e.slice(2,4),16),n=parseInt(3==e.length?e.slice(2,3).repeat(2):e.slice(4,6),16);return 0===r?"rgba("+t+", "+o+", "+n+", 0)":r?"rgba("+t+", "+o+", "+n+", "+r+")":"rgb("+t+", "+o+", "+n+")"}function t(e,r){var t=document.querySelector(e);for(var o in r)t.style[o]=r[o]}var o={cursorInnerSelector:"#cursor-inner",cursorOuterSelector:"#cursor-outer",hasRequiredStyles:!0,hideNativeCursor:!0,color:"#D3245C",outerAlpha:.3,outerBorderSize:0,hasOuterBlendMode:!1,size:{inner:8,outer:40},hoverScale:{inner:.75,outer:1.5},clickScale:{inner:1.5,outer:.13},trailingSpeed:.2,clickables:["a",'input[type="text"]','input[type="email"]','input[type="number"]','input[type="submit"]','input[type="image"]',"label[for]","select","textarea","button",".link"]};function n(n){var s=Object.assign({},o,n),i={cursorInner:document.querySelector(s.cursorInnerSelector),cursorOuter:document.querySelector(s.cursorOuterSelector),hasRequiredStyles:s.hasRequiredStyles,targetPos:{x:.5,y:.5},cursorPos:{x:.5,y:.5},endX:window.innerWidth/2,endY:window.innerHeight/2,raf:requestAnimationFrame(l),cursorVisible:!0,isScaled:!1,isClicking:!1};function c(e){var r;i.isVisible=!0,y(),i.targetPos.x=e.clientX,i.targetPos.y=e.clientY,r=e.clientX,i.cursorInner.style.setProperty("top",e.clientY+"px"),i.cursorInner.style.setProperty("left",r+"px"),i.raf||(i.raf=requestAnimationFrame(l))}function u(){i.isClicking=!0,d()}function a(){i.isScaled=!1,i.isClicking=!1,d()}function l(){if(i.cursorPos.x=e(i.cursorPos.x,i.targetPos.x,s.trailingSpeed),i.cursorPos.y=e(i.cursorPos.y,i.targetPos.y,s.trailingSpeed),i.cursorOuter.style.setProperty("top",i.cursorPos.y+"px"),i.cursorOuter.style.setProperty("left",i.cursorPos.x+"px"),Math.sqrt(Math.pow(i.targetPos.x-i.cursorPos.x,2)+Math.pow(i.targetPos.y-i.cursorPos.y,2))<.001)return window.cancelAnimationFrame(i.raf),void(i.raf=null);i.raf=requestAnimationFrame(l)}function y(){i.isVisible?(i.cursorInner.style.setProperty("opacity",1),i.cursorOuter.style.setProperty("opacity",1)):(i.cursorInner.style.setProperty("opacity",0),i.cursorOuter.style.setProperty("opacity",0))}function d(){i.isClicking?(i.cursorInner.style.setProperty("transform","translate(-50%, -50%) scale("+s.clickScale.inner+")"),i.cursorOuter.style.setProperty("transform","translate(-50%, -50%) scale("+s.clickScale.outer+")")):i.isScaled?(i.cursorInner.style.setProperty("transform","translate(-50%, -50%) scale("+s.hoverScale.inner+")"),i.cursorOuter.style.setProperty("transform","translate(-50%, -50%) scale("+s.hoverScale.outer+")")):(i.cursorInner.style.setProperty("transform","translate(-50%, -50%) scale(1)"),i.cursorOuter.style.setProperty("transform","translate(-50%, -50%) scale(1)"))}return{init:function(){var e,o,n,l;"undefined"!=typeof window&&("ontouchstart"in window||window.DocumentTouch&&"undefined"!=typeof document&&document instanceof window.DocumentTouch)||"undefined"!=typeof navigator&&(navigator.maxTouchPoints||navigator.msMaxTouchPoints)||(document.querySelectorAll(s.clickables.join(",")).forEach(function(e){return function(e){e.style.cursor="none",e.addEventListener("mouseover",function(){i.isScaled=!0,d()}),e.addEventListener("mouseout",function(){i.isScaled=!1,d()})}(e)}),document.addEventListener("mousemove",c),document.addEventListener("mousedown",u),document.addEventListener("mouseup",a),document.addEventListener("mouseleave",function(e){return function(e){var r;((r=e).clientY<=0||r.clientX<=0||r.clientX>=window.innerWidth||r.clientY>=window.innerHeight)&&(i.isVisible=!1,y())}(e)}),i.isVisible=!1,y(),e=r(s.color),o=r(s.color,s.outerAlpha),i.cursorInner.style.setProperty("background-color",e),i.cursorOuter.style.setProperty("background-color",o),i.cursorInner.style.setProperty("width",s.size.inner+"px"),i.cursorInner.style.setProperty("height",s.size.inner+"px"),i.cursorOuter.style.setProperty("width",s.size.outer+"px"),i.cursorOuter.style.setProperty("height",s.size.outer+"px"),s.hideNativeCursor&&(document.querySelector("body").style.setProperty("cursor","none"),document.querySelector("html").style.setProperty("cursor","none")),s.hasRequiredStyles&&(t(s.cursorInnerSelector,n={"pointer-events":"none",position:"fixed","border-radius":"50%",opacity:0,transform:"translate(-50%, -50%)",transition:"opacity 0.25s ease-in-out, transform 0.25s ease-in-out"}),t(s.cursorOuterSelector,n)),s.outerBorderSize>0&&i.cursorOuter.style.setProperty("border",s.outerBorderSize+"px solid "+s.color),s.hasOuterBlendMode>0&&(l=i.cursorOuter.parentElement)&&l.style.setProperty("mix-blend-mode","exclusion"))}}}n.options=o,module.exports=n;
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
new _accordionJs["default"](".accordion-container", {
  duration: 500,
  showMultiple: true,
...
},{"accordion-js":1}],11:[function(require,module,exports){
"use strict";
...
},{"aos":3}],12:[function(require,module,exports){
"use strict";
...
var bannerClose = document.querySelector('.banner__button');
...
var navMenu = document.querySelector('.menu-header');
var navLinks = document.querySelectorAll('.menu-header__link');
burgerBtn.addEventListener('click', function () {
  burgerBtn.classList.toggle('is-active');
  navMenu.classList.toggle('is-active');
  if (burgerBtn.classList.contains('is-active')) {
    (0, _scrollLock.disablePageScroll)(navMenu);
  } else {
    (0, _scrollLock.enablePageScroll)(navMenu);
  }
});
...
var btn = document.querySelector('.site-header__search');
var cardOpen = document.querySelector('.form-search');
var formClose = document.querySelector('.form-search__button-close');
btn.addEventListener('click', function () {
  btn.classList.add('is-open');
  cardOpen.classList.add('form-search_is_active');
});
formClose.addEventListener('click', function () {
  cardOpen.classList.remove('form-search_is_active');
});

},{}],16:[function(require,module,exports){
"use strict";

var _animatedCursor = _interopRequireDefault(require("animated-cursor"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
var acOptions = {
  color: '#e1670e',
  outerAlpha: 0.25,
...
var cursor = (0, _animatedCursor["default"])(acOptions);
cursor.init();

},{"animated-cursor":2}],17:[function(require,module,exports){
"use strict";
...
var sitePreloader = document.querySelector('.site-preloader');
(0, _scrollLock.disablePageScroll)(sitePreloader);
(0, _scrollLock.addFillGapTarget)(sitePreloader);
window.addEventListener('load', function () {
  window.setTimeout(function () {
    sitePreloader.classList.add('site-preloader_is_hidden');
    siteBody.classList.add('site-body_scrollbar_visible');
    (0, _scrollLock.enablePageScroll)(sitePreloader);
  }, 1500);
  window.setTimeout(function () {
    sitePreloader.classList.add('site-preloader_status_loaded');
    siteBody.classList.remove('site-preloader_is_hidden');
  }, 2000);
});

},{"scroll-lock":7}],19:[function(require,module,exports){
"use strict";

var _swiperBundle = _interopRequireDefault(require("swiper/swiper-bundle"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
var swiper = new _swiperBundle["default"]('.site-hero__swiper', {
  speed: 500,
  spaceBetween: 30,
  effect: 'fade',
  pagination: {
...
var tabsBtn = document.querySelectorAll('.site-work__step');
var tabsItem = document.querySelectorAll('.site-work__tabs');
tabsBtn.forEach(function (item) {
  item.addEventListener('click', function () {
    var currentBtn = item;
    var tabId = currentBtn.getAttribute('data-tab');
    var currentTab = document.querySelector(tabId);
    if (!currentBtn.classList.contains('site-work__step_is_active')) {
      // eslint-disable-next-line no-shadow
      tabsBtn.forEach(function (item) {
        item.classList.remove('site-work__step_is_active');
      });
      // eslint-disable-next-line no-shadow
      tabsItem.forEach(function (item) {
        item.classList.remove('site-work__tabs_is_active');
      });
      currentBtn.classList.add('site-work__step_is_active');
      currentTab.classList.add('site-work__tabs_is_active');
    }
  });
});
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
var typed = new _typed["default"]('.site-hero__description', {
  strings: ['Есть над чем задуматься: базовые сценарии поведения пользователей и&nbsp;по&nbsp;сей день остаются уделом проектантов', 'Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem Lorem '],
  typeSpeed: 10,
  backDelay: 3000,
  loop: true,
  cursorChar: '',
...
},{"typed.js":9}],22:[function(require,module,exports){
"use strict";
...
// ! Первая форма===================================================
// const selector = document.querySelector('.form__input-tel');
// const im = new Inputmask('+7 (999)-999-99-99');
// im.mask(selector);
var validation = new _justValidate["default"]('.site-footer__form', {
...
//     },
//     errorMessage: 'Введите полностью телефон',
//   },
// ])
.addField('.site-footer__name', [{
  rule: 'required',
  errorMessage: 'Это поле обязательное для заполнения!'
}, {
  rule: 'minLength',
  value: 3,
  ...
  rule: 'maxLength',
  value: 30,
  errorMessage: 'Масимальное кол-во символов - 3'
}, {
  rule: 'customRegexp',
  value: '^[A-zA-яЁё]+$',
  errorMessage: 'Неверный формат'
}]).addField('.site-footer__email', [{
  rule: 'required',
  errorMessage: 'Это поле обязательное для заполнения!'
}, {
  rule: 'email',
...
// // ! Вторая форма===================================================
// const selectorForm = document.querySelector('.form__input-tel');
// const imForm = new Inputmask('+7 (999)-999-99-99');
// imForm.mask(selectorForm);
// const validationForm = new JustValidate('.form__happy', {
//   errorFieldCssClass: 'is-invalid-form',
//   successFieldCssClass: 'is-border-form',
// });
...
//       rule: 'maxLength',
//       value: 30,
//       errorMessage: 'Масимальное кол-во символов - 15',
//     },
//   ]);

},{"just-validate":6}],23:[function(require,module,exports){
"use strict";

require("focus-visible");
require("./components/global/preloader");
require("./components/global/swiper");
require("./components/global/gsap");
require("./components/global/cursor");
require("./components/global/typed");
require("./components/global/back-top-up");
require("./components/global/banner");
require("./components/global/buttonOpen");
require("./components/global/aos-script");
require("./components/global/validation-form");
require("./components/global/accordion");
require("./components/global/tabs");
require("./components/global/burger");

},{"./components/global/accordion":10,"./components/global/aos-script":11,"./components/global/back-top-up":12,"./components/global/banner":13,"./components/global/burger":14,"./components/global/buttonOpen":15,"./components/global/cursor":16,"./components/global/gsap":17,"./components/global/preloader":18,"./components/global/swiper":19,"./components/global/tabs":20,"./components/global/typed":21,"./components/global/validation-form":22,"focus-visible":4}]},{},[23]);
